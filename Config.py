...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5282451754:AAFQqnECMqpmfmGkjAF9R-HuDPi0A5E0BMI")
    ...
    ASSISTANT_ID = int(os.environ.get("ASSISTANT_ID", "1963316264")) # telegram I'd not Username
